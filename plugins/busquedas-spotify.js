...
if (!text) return conn.sendMessage(m.chat, { text: `⪩ _Ingrese el comando y escriba el nombre de algun artista para buscarlo en spotify._\n\n• *Por ejemplo:*\n#${command} Samuel Arroyave` }, { quoted: m })
try {
