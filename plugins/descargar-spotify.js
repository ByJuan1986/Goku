...
if (!text) return conn.sendMessage(m.chat, {text: `⪩ _Ingrese el comando y el nombre de la cancion para descargarlo en *Spotify*._`, { quoted: m })
try {
await conn.sendMessage(m.chat, {text: `_Descargando la musica, espere un momento..._`, { quoted: m });
