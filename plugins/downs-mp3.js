...
if (!args[0]) return conn.sendMessage(m.chat, { text: `● _Ingrese el comando y escriba el nombre o copie un enlace de *YouTube* para pegarlo y descargarlo._` }, { quoted: m });
...
return conn.sendMessage(m.chat, { text: `● _null_` }, { quoted: m });
}} else {
return conn.sendMessage(m.chat, { text: `● _null_` }, { quoted: m });
}} else {
return conn.sendMessage(m.chat, { text: `● _null_` }, { quoted: m });
}}}
await conn.sendMessage(m.chat, { text: `_Descargando el audio, espere un momento..._` }, { quoted: m });
