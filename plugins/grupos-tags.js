...
if (!m.quoted && !text) return conn.sendMessage(m.chat, {text: `✎ _Ingrese el comando y mensione a un mensaje multimedia o cualquier cosa para replicarlo._`, { quoted: m })
try { 
...
let htextos = `${text ? text : "error: undefinedi"}`
