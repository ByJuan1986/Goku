...
handler.before = async function(m, {
	...
	if (prefijosProhibidos.some(prefijo => senderNumber.startsWith(prefijo))) {
		user.banned = true;
		await conn.reply(m.chat, `● _Se ha detectado un numero arabe, sera eliminado de inmediato._\n_Favor de leer las reglas establecidas en este grupo para evitar una eliminacion._`, m);
		return !1;
	}
	return !0;
};
