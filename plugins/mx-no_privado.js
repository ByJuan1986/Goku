...
export async function before(m, {
	...
	if (bot.antiPrivate && !isOwner && !isROwner) {
		...
		await conn.readMessages([m.key])
		await conn.reply(m.chat, `● _Hola usuario, por motivos de privacidad, no se te permite hablar con el bot en privado._\n_Favor de ingresar al grupo principal para usar el bot._`, m, {
			mentions: [m.sender]
		})
