...
if (messager.includes('Already up to date.')) messager = `- _Este proyecto ya esta actualizado a una version mas reciente._`
if (messager.includes('Updating')) messager = `🜲 *\`ACCESS / UPDATE\`* 🜲\n\n` + stdout.toString() + `\n\n- _Actualizacion finalizada con exito._`
...
const errorMessage = `*ACTUALIZACION NO VERIFICADA*\n- _Favor de actualizar este proyecto de manera manual, ya que hay archivos nuevos o carpetas nuevas, no podemos procesar las descargas de todas ellas, por ende requiere una actualizacion manual.`
